-- shops
INSERT INTO shops (id, created, shop_domain, oauth_token, country_code, currency, email, money_format)
VALUES ('61fbb484-59cf-45b2-b394-bbe830c95f75', now(), 'test-shop.myshopify.com', 'oauthtokenlol', 'nl', 'EUR', 'test@lol.bal', '{{ amount_with_comma_separator }}');

-- campaigns
INSERT INTO campaigns (id, shop_id, campaign_name, start_date, end_date)
...
-- product_variants
INSERT INTO product_variants (id, shop_id, title, sku, shopify_product_id, shopify_variant_id, price, currency)
...
-- users
INSERT INTO users (id, created) VALUES ('2eb6a046-6609-4518-ab23-87f1ad56bbaa', now());
INSERT INTO users (id, created) VALUES ('e3b937e7-ac65-4324-9d67-040cdc35b555', now());
INSERT INTO users (id, created) VALUES ('85271f15-683b-4972-bd68-b7aaacdeb70d', now());
...
INSERT INTO checkout_events (id, created, campaign_id, order_id, shop_id, user_id)
...
INSERT INTO checkout_items (id, checkout_event_id, quantity, shopify_variant_id)
